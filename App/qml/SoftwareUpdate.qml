...
Dialog {
    ...
    Text {
        ...
        text: "Retrouvez toutes les informations et documentations sur le site web\nwww.traps-ck.com"
        MouseArea {
            id: linkTextArea
            anchors.fill: parent
            hoverEnabled: true
            onClicked: Qt.openUrlExternally("http://www.traps-ck.com/doku.php?id=doc:tutoriel_wifi")
        }
    ...
    CheckBox {
        id: checkAtStartup
        text: "Prévenir au démarrage si des mises à jour sont disponibles"
        anchors.left: newVersionText.left
        anchors.bottom: dialogButtonBox.top
        checked: softwareupdate.checkAtStartup
        font.pixelSize: fontSize*0.8
        onCheckedChanged: softwareupdate.setCheckAtStartup(checkAtStartup.checked)
